...
ActiveRecord::Schema[7.0].define(version: 2023_11_10_041722) do
  ...
  create_table "private_conversations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
